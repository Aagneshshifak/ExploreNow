            ...
            <Tabs defaultValue="user" className="w-full">
              ...
              <TabsContent value="user">
                <form onSubmit={(e) => handleSubmit(e, "user")} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full h-12 bg-primary hover:bg-primary-glow text-primary-foreground font-semibold">
                    Sign In as Traveler
                  </Button>
                </form>
              </TabsContent>
              ...
              <TabsContent value="admin">
                <form onSubmit={(e) => handleSubmit(e, "admin")} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full h-12 bg-orange-600 hover:bg-orange-700 text-white font-semibold">
                    Sign In as Admin
                  </Button>
                </form>
              </TabsContent>
