...
// Resolution 8: ~461m hex edge — good balance between granularity and cell count.
// IMPORTANT: this MUST match the resolution used in location saves (location.service.ts).
// Using different resolutions for save vs search puts data in different Redis buckets.
export const DEFAULT_H3_RESOLUTION = 8;
export const MAX_SEARCH_RADIUS_METERS = 2000; // 2km cap keeps cell count ≤ ~91 cells at res 8
